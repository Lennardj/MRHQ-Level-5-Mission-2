  ...
  async.series(
    [
      async function () {
        ...
        // } catch {
        //   console.log(
        //     ">>> Download sample file failed. Sample cannot continue"
        //   );
        //   process.exit(1);
        // }
        ...
        // <Frontend>
        // localImage.addEventListener("click", async function () {
        ...
        // if (faces.length) {
        //   console.log(
        //     `${faces.length} face${faces.length == 1 ? "" : "s"} found:` // template literals adds "s" for pural faces
        //   );
        //   for (const face of faces) {
        //     console.log(
        //       `    Gender: ${face.gender}`.padEnd(20) +
        //         ` Age: ${face.age}`.padEnd(10) +
        //         `at ${formatRectFaces(face.faceRectangle)}`
        //     );
        //   }
        // } else {
